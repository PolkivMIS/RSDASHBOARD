...
const roles = {
  ...
  process_coordinator_MEGHA: {
    sheets: ["gpo_rs","assigned_task_rs","cashbook_megha","ims_megha","msl_counter_megha","production_counter_megha","p_operation","p_assigned_task","ne_operation","ne_assigned_task","machinary_po_tracker","machinary_po"],
